...
public class Rest {
	...
	@Path("/searchresult/")
	@Produces(MediaType.APPLICATION_JSON)
	public void searchResult(@QueryParam("id") Integer id, @QueryParam("blockCount") Integer blockCount,
			@QueryParam("filename") String filename, @QueryParam("fileChecksum") String fileChecksum,
			@QueryParam("metadataChecksum") String metadataChecksum) {
